...
{
    public enum ModelTypes { NONE, ANT = 100, ARMADILLO = 200, BEETLE = 300, BIRD = 400, BUTTERFLY = 500, CAT = 600, CATERPILLAR = 700, CRAB = 800, ELEPHANT = 900,  GIRAFFE = 1000, LADYBUG = 1050, LIZARD = 1100, RABBIT = 1200, SEMI_TRUCK = 1300, SNOWMAN = 1400, SPACESHIP = 1500, SQUID = 1600, TEDDYBEAR = 1700, TURTLE = 1800, WARBOAT = 1900, WINDMILL = 2000 }
